...
public class URLImageGetter implements Html.ImageGetter {
    ...
    private static final String mFilePath = QwApplication.getAppContext().getCacheDir().getAbsolutePath();
    ...
    private Drawable createPicPlaceholder() {
        ...
        drawable = new ColorDrawable(QwApplication.getAppContext().getResources().getColor(color));
